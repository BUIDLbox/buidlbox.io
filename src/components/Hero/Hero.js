    ...
    <div ref={hero} className="hero">
      <div className="hero-inner">
        ...
        <svg className="hero-bg" width="1440" height="1024" viewBox="0 0 1440 1024" preserveAspectRatio="xMaxYMax slice" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <circle cx="1415" cy="726" r="81.1813" transform="rotate(39.4085 1415 726)" fill="url(#paint0_linear_1485_3)"/>
          </g>
          <g style={{filter: 'blur(20px)'}}>
          <circle cx="401.261" cy="0.261419" r="81.1813" transform="rotate(39.4085 401.261 0.261419)" fill="url(#paint1_linear_1485_3)"/>
          </g>
          <g style={{filter: 'blur(19px)'}}>
          <circle cx="397.702" cy="892.701" r="21.1024" transform="rotate(39.4085 397.702 892.701)" fill="url(#paint2_linear_1485_3)"/>
          </g>
          <g style={{filter: 'blur(20px)'}}>
          <circle cx="704.702" cy="287.701" r="21.1024" transform="rotate(39.4085 704.702 287.701)" fill="url(#paint3_linear_1485_3)"/>
          </g>
          ...
          <defs>
            ...
            <filter id="filter2_f_1485_3" x="364.599" y="859.598" width="66.2061" height="66.206" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
            <feFlood flood-opacity="0" result="BackgroundImageFix"/>
            <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"/>
            <feGaussianBlur stdDeviation="6" result="effect1_foregroundBlur_1485_3"/>
            </filter>
            <filter id="filter3_f_1485_3" x="671.599" y="254.598" width="66.2061" height="66.206" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
            <feFlood flood-opacity="0" result="BackgroundImageFix"/>
            <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"/>
            <feGaussianBlur stdDeviation="6" result="effect1_foregroundBlur_1485_3"/>
            </filter>
            ...
            <linearGradient id="paint1_linear_1485_3" x1="320.08" y1="-0.671672" x2="482.443" y2="-0.671674" gradientUnits="userSpaceOnUse">
            <stop stopColor="#FFC800"/>
            <stop offset="1" stopColor="#16DBBE"/>
            </linearGradient>
            ...
            <linearGradient id="paint12_linear_1485_3" x1="878" y1="95.4598" x2="972" y2="95.4598" gradientUnits="userSpaceOnUse">
            <stop stopColor="#E54DE5"/>
            <stop offset="1" stopColor="#FFC800"/>
            </linearGradient>
