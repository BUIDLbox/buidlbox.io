...
<template>
  <div class="bg-dark-blue mb-16 w-screen">
    <Header />
    ...
    <div class="flex flex-col gap-32">
      ...
      <div class="bg-gradient-to-b from-tertiary-surface to-dark-blue from-35%">
        <div class="bg-hero-bg w-full bg-top bg-contain bg-no-repeat">
          <div
            class="bg-secondary py-2 overflow-hidden w-screen relative min-h-[44px] items-center justify-center"
          >
            <div
              class="animate-scroll translate-x-full flex items-center justify-center gap-24 lg:gap-32 w-full py-1"
            >
              <span></span>
              <a
      ...
      <div class="px-4">
        ...
        <div
          class="flex flex-wrap items-center justify-center gap-x-12 gap-y-16"
        >
            ...
            <div class="flex-shrink-0">
              ...
              >
                ...
                <div class="w-full">
                  ...
                  <p class="mb-12 slide-in-section">
                    Our hackathon dashboard is fully-equipped with everything
      ...
      <div class="bg-gradient-to-b from-dark-blue to-tertiary-surface pb-24">
        <div class="grid gap-24 max-w-6xl m-auto">
          <div class="flex flex-col items-center text-center">
            ...
            >
              Through hackathons and bounties, our platform provides the tools
