...
const textClassification = {
  ...
  inner:
    "focus-within:shadow-none focus-within:border-positive shadow-none border border-around-forms focus:border-positive border border-around-forms rounded bg-inherit w-full flex focus:ring-positive ring-offset-red-200 mb-1 overflow-hidden focus:border-positive focus-within:!border-positive py-0",
  input:
    "w-full px-3 bg-inherit focus:ring-positive ring-offset-gray-300 ring-positive text-sm text-on-surface placeholder-on-surface-tertiary focus:!outline-none ",
  ...
  selector:
    "text-on-surface py-0 text-sm border !border-around-forms  ring-offset-gray-300 focus:ring-positive focus:border-positive focus-within:!border-positive bg-inherit",
